...
def main(argv=None):
    ...
    parser.add_argument("infile_f", help='a space-delimited output file from hmmer')
    ...
    if isinstance(args.infile_f, str):
        with open(args.infile_f, 'r') as f:
            filtered_df = apply_thresholds(f, args.hmm_name, args.out_filt_f, args.out_excl_f)
    else:
